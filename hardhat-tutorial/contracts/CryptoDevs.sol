...
contract CryptoDevs is ERC721Enumerable, Ownable {
    /**
        @dev _baseTokenURI for computing(tokenURI). if set, the resulting URI for each token will be concatenation of the 'baseURI' and the 'tokenid'
     */
    ...
    // _pasused is used to pause the contract in case of an emergency
    bool public _paused;
    ...
    /**
        ...
        - it also initialises an instances of whitelist interface
      */
    ...
    function startPresale() public onlyOwner {
        presaleStarted = true;
        // set presaleEnded time as a current timestamp + 5 minutes
    ...
    function presaleMint() public payable onlyWhenNotPaused {
        ...
        // if the address being minted to is not a contract, it works the same was as _mint
